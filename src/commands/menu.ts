...
module.exports = {
	...
	callback: function (main, ctx) {
		...
		if (ins) {
			msg += "\r\n</code>--- --- --- --- --- --- --- ---<code>";
			msg +=
				msgs.info20 + Utils.stToStr(msgs.langCode, ins.connectionState);
			// connected?
			if (ins.connectionState == 2) {
				...
				msg +=
					msgs.info23 +
					ins.serverinfo.virtualserver_version.split(" ")[0];
				msg +=
					msgs.info24 +
					ins.users.length +
					" / " +
					ins.serverinfo.virtualserver_maxclients;
				msg +=
					msgs.info25 + ins.serverinfo.virtualserver_channelsonline;
			}
