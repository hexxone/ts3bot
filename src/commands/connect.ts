			...
			switch (ctx.groupBinding.instance.connectionState) {
				...
				case 3:
					...
					try {
						...
						ctx.respondChat(
							ctx.groupMessages.errorPrefix + JSON.stringify(e),
							ctx.opt
						);
					}
					break;
			...
			switch (ctx.senderSelectedInstance.connectionState) {
				...
				case 3:
					...
					try {
						...
						ctx.respondChat(
							ctx.senderMessages.errorPrefix + JSON.stringify(e),
							ctx.opt
						);
					}
					break;
